...
public interface MonedaDAO 
{
    ...
    List<Moneda> listarMonedasFiat() throws SQLException;
    List<Moneda> listarMonedasCripto() throws SQLException;
	...
	List<Moneda> listarMonedasOrdenado();
	int consultarCantidadMonedas();
}
